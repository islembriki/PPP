...
# Données basées sur tes résultats de nettoyage
classes = ['Background', 'Bebop', 'AR Drone', 'Phantom']
counts_initial = [82000, 19000, 15000, 4000] # Tes chiffres approximatifs après nettoyage
...
# --- GRAPHIQUE 1 : Distribution Réelle (Déséquilibrée) ---
...
# --- GRAPHIQUE 2 : Distribution dans un Batch (Grâce au Sampler) ---

...
# Liste exacte des noms de fichiers que tu as sur ta capture d'écran
...
def convert_to_json():
    # Vérification : Est-ce que les fichiers existent ici ?
    ...
    for snr, filename in detailed_files.items():
        if os.path.exists(filename):
            ...
            print(f"⚠️ Warning : Fichier {filename} manquant.")
